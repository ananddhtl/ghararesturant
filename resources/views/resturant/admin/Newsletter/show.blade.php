                ...
                <div class="container-fluid p-4">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('contacts.show', $contacts->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputSubject1"
                                                        ...
                                                        value="{{ $contacts->subject }}" disabled>
                                                    @error('subject')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        ...
                                                        value="{{ $contacts->food_status }}" disabled>
                                                    @error('food_status')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" disabled id="exampleFormControlTextarea1" rows="3" name='message'>{{ $contacts->message }}</textarea>
                                                    @error('message')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
