                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">type</label>
                                                        <select class="form-select " id="select1" name="type" value="{{ $food->type }}">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input price="number"class="form-control"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                    ...
                                                                    @foreach ($files as $file)
                                                                        <label>
                                                                            ...
                                                                            <img src="{{ asset('uploads/' . $file->img) }}"
                                                                                alt="" height="100px;"
                                                                                width="100px;" style="margin-right:20px; margin-bottom:10px;">
                                                                        </label>
                                                                    @endforeach
                                                ...
                                                <div class="input-group mb-3 col">
                                                    <input id="imagebox" type="text" class="form-control"
                                                        name="img" readonly value="{{ $food->file_id }}|{{ $food->img }}">
